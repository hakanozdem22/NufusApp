...
declare global {
  interface Window {
    ...
    api: {
      ...
      // Kurum Harcama
      getKurumHarcamalar: (params?: any) => Promise<any[]>
      addKurumHarcama: (data: any) => Promise<string>
      updateKurumHarcama: (data: any) => Promise<void>
      deleteKurumHarcama: (id: string) => Promise<void>
      getKurumHarcamaKategoriler: () => Promise<any[]>
      addKurumHarcamaKategori: (data: any) => Promise<string>
      deleteKurumHarcamaKategori: (id: string) => Promise<void>

      // Belge Doğrulama Siteleri
      getBelgeDogrulamaSiteleri: () => Promise<any[]>
      addBelgeDogrulamaSitesi: (data: any) => Promise<string>
      updateBelgeDogrulamaSitesi: (data: any) => Promise<void>
      deleteBelgeDogrulamaSitesi: (id: string) => Promise<void>
