...
import { CheckCircle, AlertCircle, Bot, ClipboardList, LayoutDashboard, List, LayoutTemplate, Sparkles } from 'lucide-react'
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      default:
        return (
          <div className="h-full overflow-hidden p-8">
            <div className="w-full h-full rounded-[2.5rem] bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-gray-100 dark:border-gray-800 shadow-xl overflow-hidden">
              <EgitimSettingsPanel
                tarih={vm.tarih}
