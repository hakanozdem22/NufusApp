...
import { Paperclip, Trash2, CalendarCheck2, Zap } from 'lucide-react'
...
export const TakvimGrid = ({
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl border border-gray-100 dark:border-gray-800 shadow-xl flex flex-col h-full overflow-hidden group">
      {/* Gün İsimleri Header */}
          ...
          return (
            ...
            >
              <div className="flex justify-between items-start">
                 <span
                  className={`text-xs font-black w-8 h-8 flex items-center justify-center rounded-lg transition-all duration-500
                    ${bugunMu 
