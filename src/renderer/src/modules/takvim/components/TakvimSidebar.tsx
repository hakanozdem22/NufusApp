...
export const TakvimSidebar = ({ yaklasanlar, onItemClick, onDelete }: TakvimSidebarProps): ReactElement => {
  ...
  return (
    <div className="w-96 bg-white/40 dark:bg-gray-900/40 backdrop-blur-2xl rounded-2xl border border-white/20 dark:border-gray-800 shadow-xl flex flex-col overflow-hidden shrink-0 transition-all duration-500 group relative">
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-4 scrollbar-hide">
        {yaklasanlar.length === 0 ? (
          <div className="text-center text-gray-400 dark:text-gray-500 py-20 flex flex-col items-center gap-4 opacity-30">
            <div className="w-16 h-16 rounded-2xl bg-white/20 dark:bg-gray-800 border-2 border-dashed border-white/20 flex items-center justify-center">
