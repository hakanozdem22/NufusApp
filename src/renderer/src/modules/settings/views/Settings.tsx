...
class ErrorBoundary extends Component<{ children: ReactNode }, { hasError: boolean; error: any }> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="p-8 text-red-600 border border-red-300 rounded bg-red-50 m-4">
          <h2 className="font-bold mb-2 text-lg">Ayarlar Modülü Hatası</h2>
          <p className="mb-2">Bir hata oluştuğu için bu ekran görüntülenemiyor.</p>
      ...
      <div className="flex h-full bg-gray-50 dark:bg-gray-900 overflow-hidden transition-colors">
        ...
        <div className="flex-1 overflow-auto p-8">
          <div className="max-w-5xl">
            ...
            {activeTab === 'arsiv' && (
              <div key="arsiv-settings-container">
                <ArsivSettings />
              </div>
            )}
