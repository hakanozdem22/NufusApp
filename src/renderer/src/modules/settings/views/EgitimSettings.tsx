...
import { useEgitimSettings } from '../viewmodels/useEgitimSettings'
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="p-6">
          <form onSubmit={handleDuzenleyenSubmit} className="flex gap-3 mb-6 items-end">
            <div className="flex-1">
              <label className="block text-xs font-medium text-gray-700 mb-1">Düzenleyen Adı</label>
              <input
                type="text"
                placeholder="Ad Soyad"
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                  {egitimDuzenleyenler.map((item) => (
                    <tr
                      key={item.id}
                      className={`hover:bg-gray-50 dark:hover:bg-gray-700/50 ${
                        duzenlenenDuzenleyenId === item.id
                          ...
                          onBlur={(e) => {
                            ...
                            if (newSira !== item.sira) {
                              ...
                              if (newSira !== undefined) {
                                ...
                                if (duplicate) {
                                  mesajGoster(
                                    `Bu sıra numarası (${newSira}) zaten "${duplicate.baslik}" konusuna verilmiş!`,
                                    'hata'
                                  )
