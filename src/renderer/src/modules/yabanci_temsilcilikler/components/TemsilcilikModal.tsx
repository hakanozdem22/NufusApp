...
interface Props {
  ...
  initialData?: Temsilcilik | null
}

export function TemsilcilikModal({ isOpen, onClose, onSave, initialData }: Props) {
  const [formData, setFormData] = useState<Partial<Temsilcilik>>({
    ulke: '',
    tip: 'Büyükelçilik',
    sehir: 'Ankara',
    adres: '',
  ...
  const { getFlagByName } = useTemsilcilikViewModel()
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-5xl h-[85vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-300 border border-gray-100 dark:border-gray-700 transition-colors">
        {/* HEADER */}
        <div className="bg-gradient-to-r from-teal-600 via-emerald-600 to-emerald-500 px-8 py-5 flex justify-between items-center shrink-0 relative overflow-hidden">
          {/* Decorative shapes */}
          ...
          <div className="flex items-center gap-4 relative z-10">
            ...
            <div>
              ...
              <p className="text-emerald-50 text-sm font-medium opacity-90">
                {initialData ? formData.ulke : 'Sisteme yeni bir yabancı temsilcilik tanımlayın'}
              </p>
            </div>
          </div>
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div className="w-full text-left space-y-1.5 mt-2">
                    ...
                    <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-1 leading-tight text-center">
                      * Bayrak, girilen ülke adına göre otomatik atanır. Girmek istediğiniz ülke{' '}
                      ...
                      gibi resmi isimleriyle eşleştiğinde görünür olacaktır.
                    </p>
                  </div>
                  ...
                  <div className="w-full text-left space-y-1.5">
                    ...
                    />
                    <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-1 leading-tight text-center">
                      * Eğer ülke adıyla bayrak eşleşmezse, buraya 2 harfli ülke kodunu girerek
                      bayrağı atayabilirsiniz. (Boş bırakılırsa ülke adı kullanılır)
                    </p>
                  </div>
                  ...
                  <div className="w-full text-left space-y-1.5">
                    ...
                    <select
                      ...
                      className="w-full bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 p-3.5 rounded-xl text-sm font-semibold text-gray-700 dark:text-gray-200 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white dark:focus:bg-gray-700 transition-all outline-none"
                    >
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col transition-colors">
                ...
                <div className="p-6 space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      type="text"
                      className="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 px-4 py-3 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-200 outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 dark:focus:ring-emerald-900/40 transition-colors"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      rows={3}
                      className="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 px-4 py-3 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-200 outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 dark:focus:ring-emerald-900/40 transition-colors resize-none"
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col transition-colors">
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1.5 md:col-span-2">
                    ...
                    <input
                      type="url"
                      className="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 px-4 py-3 rounded-xl text-sm font-medium text-blue-600 dark:text-blue-400 outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 dark:focus:ring-emerald-900/40 transition-colors"
        ...
        <div className="px-8 py-5 border-t border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 flex justify-end gap-4 shrink-0 relative z-20 shadow-[-10px_0_20px_rgba(0,0,0,0.05)] transition-colors">
          ...
          <button
            type="submit"
            form="temsilcilik-form"
            disabled={isSubmitting}
            className="px-8 py-2.5 bg-gradient-to-r from-teal-600 to-emerald-600 dark:from-teal-500 dark:to-emerald-500 text-white rounded-xl font-bold shadow-lg shadow-emerald-200 dark:shadow-none hover:shadow-emerald-300 hover:-translate-y-0.5 active:translate-y-0 active:shadow-sm transition-all text-sm flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <Save size={18} />
            {isSubmitting
              ? 'Kaydediliyor...'
