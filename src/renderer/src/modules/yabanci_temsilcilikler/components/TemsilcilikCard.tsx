...
import { Globe, Trash2, Phone, Mail, MapPin, Plus, Edit3, MessageCircle } from 'lucide-react'
...
export const TemsilcilikCard = ({
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-xl flex flex-col overflow-hidden relative group hover:shadow-indigo-500/10 transition-all duration-500 border-white/20">
      {/* GÖRSEL ALANI - Bayrak */}
