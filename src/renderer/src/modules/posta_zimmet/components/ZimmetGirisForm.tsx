...
export const ZimmetGirisForm = ({
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl p-8 rounded-lg border border-gray-100 dark:border-gray-800 shadow-xl relative overflow-hidden group">
      ...
      <div className="flex items-center gap-3 mb-8 relative">
        <div className="w-10 h-10 rounded-lg bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 border border-blue-100 dark:border-blue-800/50 shadow-inner">
      ...
      <form onSubmit={onAdd} className="space-y-6 relative">
        <div className="grid grid-cols-2 gap-5">
           <div className="space-y-2">
            ...
            <div className="relative group/input">
              ...
              <input
                className="w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-gray-800 border-none rounded-lg text-sm font-bold outline-none ring-4 ring-transparent focus:ring-blue-500/10 transition-all dark:text-white shadow-inner"
                value={evrakNo}
          ...
          <div className="space-y-2">
            ...
            <div className="relative group/input">
              ...
              <input
                className="w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-gray-800 border-none rounded-lg text-sm font-black font-mono uppercase outline-none ring-4 ring-transparent focus:ring-blue-500/10 transition-all dark:text-white shadow-inner"
                value={barkod}
        ...
        <div className="space-y-2">
          ...
          <div className="relative group/input">
            ...
            <input
              className="w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-gray-800 border-none rounded-lg text-sm font-bold uppercase outline-none ring-4 ring-transparent focus:ring-blue-500/10 transition-all dark:text-white shadow-inner"
              value={yer}
        ...
        <div className="space-y-2">
          ...
          <div className="relative group/input">
            ...
            <input
              type="number"
              step="0.1"
              className="w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-gray-800 border-none rounded-lg text-sm font-black outline-none ring-4 ring-transparent focus:ring-blue-500/10 transition-all dark:text-white shadow-inner"
              value={ucret}
        ...
        <button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-lg font-black shadow-lg shadow-blue-500/25 flex justify-center items-center gap-3 transition-all active:scale-95 text-xs uppercase tracking-[0.2em] mt-2">
