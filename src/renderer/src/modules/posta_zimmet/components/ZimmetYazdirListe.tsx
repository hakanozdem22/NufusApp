...
export const ZimmetYazdirListe = ({
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-xl flex flex-col h-full overflow-hidden border border-gray-100 dark:border-gray-800">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide py-4">
        {liste.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center p-8 text-center">
            <div className="w-16 h-16 rounded-3xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-gray-300 dark:text-gray-600 mb-4 animate-pulse">
