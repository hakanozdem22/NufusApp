...
export const DashboardCard = ({
  ...
  return (
    <div
      ...
      className="group relative bg-white/60 dark:bg-gray-900/40 backdrop-blur-xl p-4 rounded-3xl border border-white/20 dark:border-gray-800/50 shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer flex items-center gap-4 overflow-hidden hover:scale-[1.02] active:scale-95 ring-1 ring-transparent hover:ring-blue-500/30"
    >
