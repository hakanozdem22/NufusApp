...
import { ApostilUlke } from '../models/apostil-types'

interface EApostilListProps {
  liste: ApostilUlke[]
  ...
  onEdit: (item: ApostilUlke) => void
  onDelete: (id: number) => void
}

export const EApostilList = ({
  liste,
  getFlagSrc,
  getFlagByName,
  imgHatalari,
            ...
            >
              ...
              <div className="absolute top-2 right-2 z-10 flex gap-1">
                ...
                <div
                  ...
                  title={
                    (item.dosya_sayisi || 0) > 0
                      ? `${item.dosya_sayisi} Adet Dosya/Belge`
                      : 'Dosya/Belge Yok'
                  }
                >
                  <FileText size={14} />
