...
import { ApostilDosya, SiteLink } from '../models/apostil-types'

interface EApostilFormModalProps {
  isOpen: boolean
  onClose: () => void
  onSave: () => void
  form: any
  ...
  dosyalar: ApostilDosya[]
  yeniDosya: any
  setYeniDosya: (val: any) => void
  dosyaSec: () => void
  dosyaEkle: () => void
...
export const EApostilFormModal = ({
  isOpen,
  onClose,
  onSave,
  form,
          ...
          <div className="flex items-center gap-4 relative z-10">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white tracking-tight">
                {form.id ? 'Ülke Detayları' : 'Yeni Ülke Ekle'}
              </h2>
              <p className="text-blue-100 text-sm font-medium opacity-90">
                {form.id ? form.ulke_adi : 'Sisteme yeni bir e-apostil ülkesi tanımlayın'}
              </p>
            </div>
          </div>
