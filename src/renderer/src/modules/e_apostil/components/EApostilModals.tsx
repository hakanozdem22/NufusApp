...
interface EApostilDeleteModalProps {
  isOpen: boolean
  onClose: () => void
  onConfirm: () => void
}

export const EApostilDeleteModal = ({ isOpen, onClose, onConfirm }: EApostilDeleteModalProps) => {
...
interface EApostilDefaultModalProps {
  isOpen: boolean
  onClose: () => void
  onConfirm: () => void
}

export const EApostilDefaultModal = ({ isOpen, onClose, onConfirm }: EApostilDefaultModalProps) => {
  if (!isOpen) return null
  return (
    <div className="fixed inset-0 bg-black/50 z-[60] flex items-center justify-center p-4 backdrop-blur-sm">
