...
export const TurkTemsilcilikCard = ({
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl border border-gray-100 dark:border-gray-800 shadow-xl flex flex-col overflow-hidden relative group hover:shadow-red-500/10 transition-all duration-500 border-white/20">
      {/* GÖRSEL ALANI - Bayrak */}
