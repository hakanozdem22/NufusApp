    ...
    <div className="flex flex-col h-full bg-slate-50/50 dark:bg-gray-950/50 transition-colors duration-500 overflow-hidden">
        ...
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl px-10 py-8 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-xl relative overflow-hidden group">
          ...
          <div className="flex flex-col xl:flex-row justify-between items-center gap-8 relative">
            ...
            <div className="flex items-center gap-6 self-start xl:self-center shrink-0">
              <div className="w-16 h-16 bg-gradient-to-br from-red-500 to-rose-700 text-white rounded-[1.4rem] flex items-center justify-center shadow-lg shadow-red-500/20 group-hover:rotate-6 transition-transform duration-500">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5 w-full xl:w-auto">
              <div className="flex items-center gap-3 w-full sm:w-auto">
                <div className="relative group/search w-full sm:w-80">
                  ...
                  />
                  <input
                    className="pl-14 pr-6 py-4 w-full bg-slate-50 dark:bg-gray-800/80 border-none rounded-3xl text-sm font-bold outline-none ring-4 ring-transparent focus:ring-red-500/10 focus:bg-white dark:focus:bg-gray-900 transition-all dark:text-white shadow-inner placeholder-gray-400"
      ...
      <div className="flex-1 overflow-y-auto px-8 pb-12 scrollbar-hide max-w-[1700px] mx-auto w-full">
        {loading && temsilciliklerGrup.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-red-500 font-black uppercase tracking-widest bg-red-50 dark:bg-red-950/20 rounded-[3rem] border border-red-100 dark:border-red-900/30 p-20 gap-4 text-center">
